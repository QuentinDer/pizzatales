...
public class Rifle extends Firearm {
	...
	public void shootUp(int x, int y) {
		setSpriteUp();
		shootingCounter++;
		holderprojectiles.add(new RifleBullet(x+15, y, 0, -1, speed, projectiledmg, range));
	}
	...
	public void shootLeft(int x, int y) {
		setSpriteLeft();
		shootingCounter++;
		holderprojectiles.add(new RifleBullet(x-25, y, -1, 0, speed, projectiledmg, range));
	}
	...
	public void shootRight(int x, int y) {
		setSpriteRight();
		shootingCounter++;
		holderprojectiles.add(new RifleBullet(x+30, y, 1, 0, speed, projectiledmg, range));
	}
	...
	public void shootUpLeft(int x, int y) {
		setSpriteLeftUp();
		shootingCounter++;
		holderprojectiles.add(new RifleBullet(x-25, y-20, -0.7f, -0.7f, speed, projectiledmg, range));
	}
	...
	public void shootDownLeft(int x, int y) {
		setSpriteLeftDown();
		shootingCounter++;
		holderprojectiles.add(new RifleBullet(x-25, y+30, -0.7f, 0.7f, speed, projectiledmg, range));
	}
